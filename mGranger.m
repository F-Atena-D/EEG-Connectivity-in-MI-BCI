% function mGranger:
% Description: This function computes the mean Granger Causality by
% adapting the code from Brainstorm Software
% https://neuroimage.usc.edu/brainstorm
% for a given multichannel time series data.

function [connectivity, pValue, connectivityV, pValueV, X, Y] = mGranger(X, Y, order, inputs)
